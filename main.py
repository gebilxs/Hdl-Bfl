...
if __name__ =='__main__':
    ...
    # FL attributes
    parser.add_argument('-d','--dataset', type=str, default='mnist-1',help = 'chose dataset to train and test,default mnist')
    ...
    parser.add_argument('-nm', '--num_malicious', type=int, default=2, help="number of malicious nodes in the network. malicious node's data sets will be introduced Gaussian noise")
    ...
    parser.add_argument('-ko', '--knock_out_rounds', type=int, default=2, help="a worker or validator device is kicked out of the device's peer list(put in black list) if it's identified as malicious for this number of rounds")
    ...
    parser.add_argument('-vh', '--validator_threshold', type=float, default=10, help="a threshold value of accuracy difference to determine malicious worker")
